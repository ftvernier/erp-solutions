...
O PO-UI disponibiliza documentação oficial estruturada para LLMs.
**Antes de implementar qualquer componente, busque a referência via web_fetch.**
...
- [ ] Fiz `web_fetch` na doc do(s) componente(s) PO-UI usados?
