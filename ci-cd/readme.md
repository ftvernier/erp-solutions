...
parar_servicos() {
    ...
    for servico in monitorar_webapp appserver_broker_rest appserver_broker_webapp  appserver_portal_01 appserver_compilar appserver_slave_01 
    do
...
Clone o repositório em /opt/git_protheus/protheus/
Copie o workflow para .github/workflows/deploy.yml
Configure as permissões do runner para acessar os diretórios do Protheus
Teste o script gerenciar_servicos.sh
...
Identifique o backup na pasta com timestamp anterior
Execute o rollback manual:
bash
# Parar serviços
